...
======= -->
    <div
        class="w-full flex flex-col items-center justify-between py-3 px-14 bg-cover bg-[url('./resource/section-nuisance-bg.svg')]">
        ...
        <div class="flex items-center justify-between pb-5">
            <div class="px-5 w-80">
                <p class="text-sm">Notre association lutte contre la pollution et l'urbanisation qui menacent la
                    biodiversité de la rivière. Informez-vous sur ces enjeux cruciaux pour préserver cet écosystème
                    fragile !</p>
            </div>
            <div class="w-40">
